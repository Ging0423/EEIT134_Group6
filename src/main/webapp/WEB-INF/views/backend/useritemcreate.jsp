...
<h1 style="color:#fff">新增會員商品資料</h1><br>
<hr>
<form method="post" action="createuseritem" enctype="multipart/form-data">

    <table>
    <tr><td>會員編號:</td></tr>
	<tr><td><input id="userId" name=userId type="number"></td></tr>
	<tr><td>商品名稱:</td></tr>
	<tr><td><input id="itemName" name="itemName" type="text" /></td></tr>
	<tr><td>商品描述:</td></tr>
	<tr><td><textarea id="itemDescription"name="itemDescription" rows="4" cols="21"></textarea></td></tr>
	<tr><td><input class=a type="hidden" name="addDate" value="${userData.addDate}"></td></tr>
	<tr><td>數量:</td></tr>
	<tr><td><input id="qty" name="qty" type="number" min="0"/></td></tr>
	<tr><td>價錢:</td></tr>
	<tr><td><input id="price" name="price" type="number" min="0"/></td></tr>
	</table>
      <div id="imgClass"><br>
...
<!-- 	  <input type="submit" value="送出"></input> -->
        ...
        <a href="<c:url value='/backend/useritem' />">會員商品資料總表</a>
        </div>
      <script>	
		function magic() {	
