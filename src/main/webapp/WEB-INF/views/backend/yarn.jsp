					...
					<table class="table table-bordered border-primary" id="ajaxTable">
						...
						<tbody>
							<tr>
								...
								<td><input readonly name="addDate" value=${yarnData.addDate}></td>
								<td><input class=a name="qty" value=${yarnData.qty}></td>
								<td><input class=a name="price" value=${yarnData.price}></td>
							</tr>
						</tbody>
						<thead>
							<tr>
						...
						<tbody>
							<tr>
								<td colspan="4"><textarea cols="190" rows="8" name="itemDescription">${yarnData.itemDescription}</textarea></td>
							</tr>
						</tbody>
						<thead>
							<tr>
