...
meta name ="viewport " content ="width =device-width, initial-scale =1 
	...
	/libs /font-awesome /4.7.0 /css /font-awesome.min.css "> body {
	font-family: Arial;
}
				...
				<form method="post" action="<c:url value='/backend/updatebooks'/>"
					...
					<table class="table table-bordered border-primary" id="ajaxTable">
						...
						<tbody>
							...
							<tr>
								<td colspan="2"><input size="100" name="itemName"
									value=${booksData.itemName}></td>
								<td><input name="publisher" value=${booksData.publisher}></td>
								<td><input class=a name="author" value=${booksData.author}></td>
							</tr>
						</tbody>
						<thead>
							<tr>
								<th colspan="4">內容簡介</th>
							</tr>
						</thead>
						<tbody>
							<tr>
					...
					<br>
					<button class="btn" type="submit" onclick='update()'>更新</button>
				</form>
