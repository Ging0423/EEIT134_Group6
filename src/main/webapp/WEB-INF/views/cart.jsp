			...
			<div class="cart_inner">
				<div class="table-responsive">
                  ...
                  <div class="product_count">
                    ...
                    <input class="input-number" type="number" name="qty" value="${item.qty}" min="1" max="10">
                    <span class="input-number-increment"> <i class="ti-plus"></i></span>
                  </div>
                </td>
                <td>
										<h5><c:set var="total" value="${item.qty*item.price}"/><c:out value="${total}"/></h5>
										</td>
									</tr>
								...
								<tr class="bottom_button">
									<td><button class="btn_1" onclick="updateCart()">更新購物車</button></td>
					...
					<div class="checkout_btn_inner float-right">
						<a class="btn_1" href="#">繼續購物</a> <a
							class="btn_1 checkout_btn_1" type="submit">結帳去</a>
					</div>
 					</form>
				</div>
			</div>
					   ...
					   if(data==null){
						   ...
						   $.each(data, function(i,n){
							   ...
							   var tr = '<tr>'+
								...
								'<div class="media">'+
									'<div class="d-flex">'+
										'<img src="img/arrivel/arrivel_1.png" alt="" />'+ '<input type="hidden" name="itemId" value="'+n.itemId+'">'+
									'</div>'+
									'<div class="media-body">'+
										'<p>'+n.itemName+'</p>'+
									'</div>'+
