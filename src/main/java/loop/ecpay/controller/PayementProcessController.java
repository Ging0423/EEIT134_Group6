...
import loop.ecpay.model.ShoppingCart;
...
public class PayementProcessController {
	...
	@GetMapping("/goECPay")
	public void connectToEcPayment(Model model, HttpServletResponse response) {
...
//		String invoiceTitle = request.getParameter("InvoiceTitle");	// 發票的抬頭
		...
		payementService.prepareECPayData(orderBean, response);
