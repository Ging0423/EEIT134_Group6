...
import loop.ecpay.payment.integration.domain.ATMRequestObj;
import loop.ecpay.payment.integration.domain.AioCheckOutALL;
import loop.ecpay.payment.integration.domain.AioCheckOutATM;
import loop.ecpay.payment.integration.domain.AioCheckOutBARCODE;
import loop.ecpay.payment.integration.domain.AioCheckOutCVS;
import loop.ecpay.payment.integration.domain.AioCheckOutDevide;
import loop.ecpay.payment.integration.domain.AioCheckOutOneTime;
import loop.ecpay.payment.integration.domain.AioCheckOutPeriod;
import loop.ecpay.payment.integration.domain.AioCheckOutWebATM;
import loop.ecpay.payment.integration.domain.CVSOrBARCODERequestObj;
import loop.ecpay.payment.integration.domain.CreateServerOrderObj;
import loop.ecpay.payment.integration.domain.DoActionObj;
import loop.ecpay.payment.integration.domain.FundingReconDetailObj;
import loop.ecpay.payment.integration.domain.InvoiceObj;
import loop.ecpay.payment.integration.domain.QueryCreditCardPeriodInfoObj;
import loop.ecpay.payment.integration.domain.QueryTradeInfoObj;
import loop.ecpay.payment.integration.domain.QueryTradeObj;
import loop.ecpay.payment.integration.domain.TradeNoAioObj;
import loop.ecpay.payment.integration.ecpayOperator.EcpayFunction;
import loop.ecpay.payment.integration.errorMsg.ErrorMessage;
import loop.ecpay.payment.integration.exception.EcpayException;
import loop.ecpay.payment.integration.verification.VerifyAioCheckOut;
import loop.ecpay.payment.integration.verification.VerifyCreateServerOrder;
import loop.ecpay.payment.integration.verification.VerifyDoAction;
import loop.ecpay.payment.integration.verification.VerifyFundingReconDetail;
import loop.ecpay.payment.integration.verification.VerifyQueryCreditTrade;
import loop.ecpay.payment.integration.verification.VerifyQueryTrade;
import loop.ecpay.payment.integration.verification.VerifyQueryTradeInfo;
import loop.ecpay.payment.integration.verification.VerifyTradeNoAio;
